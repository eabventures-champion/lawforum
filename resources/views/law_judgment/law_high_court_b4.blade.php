...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <meta name="description" content="Browse and search Ghana High Court case laws and judgements on Legals Forum.">
    <title>High Court - Legals Forum</title>
    ...
    <style>
        ...
        .nav-wrap { position: fixed; top: 0; left: 0; width: 100%; z-index: 1000; background: rgba(6, 10, 19, 0.88); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border-bottom: 1px solid var(--border-color); transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); }
        .nav-inner { max-width: 1280px; margin: 0 auto; padding: 18px 40px; display: flex; align-items: center; justify-content: space-between; line-height: 1; }
        ...
        .nav-underline-premium { display: flex; gap: 6px; overflow-x: auto; padding: 8px; background: rgba(148, 163, 184, 0.08) !important; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(148, 163, 184, 0.25) !important; border-radius: 12px; margin-bottom: 24px; flex-wrap: nowrap !important; position: sticky; top: 62px; z-index: 99; scrollbar-width: none !important; -ms-overflow-style: none !important; }
        .nav-underline-premium::-webkit-scrollbar { display: none !important; width: 0 !important; height: 0 !important; }
        ...
        .mobile-nav-panel a { font-size: 22px; font-weight: 600; color: var(--text-secondary); padding: 12px 24px; border-radius: 12px; line-height: 1.5; transform: translateY(24px); opacity: 0; transition: all 0.3s ease, transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.5s ease; text-decoration: none !important; }
        .mobile-nav-panel.open a { transform: translateY(0); opacity: 1; }
  ...
  <body>
    ...
    <div class="container-fluid px-md-5 mt-4">
        <div class="mb-4">
            <h1 class="page-title" style="font-size: 2.2rem; font-weight: 800; font-family: 'Outfit', sans-serif; letter-spacing: -0.5px; background: linear-gradient(135deg, #fff 0%, #94a3b8 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">High Court</h1>
            <p class="page-subtitle" style="font-size: 15px; color: var(--text-secondary); line-height: 1.6;">Browse and search Ghana High Court case laws and judgements.</p>
        </div>
        <div class="row">
            <div class="col-md-9">
                <div class="nav-underline-premium">
                    ...
                    <a class="nav-link-premium active" href="/judgement/2/High-Court"><i class="fa-solid fa-building-columns mr-2"></i> High Court</a>
                </div>
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead><tr><th>High Court</th><th>Ref No.</th><th>Year</th></tr></thead>
                            <tbody>
                              @foreach($highCourts as $highCourt)
                                <tr>
                                    <td><a href="/judgement/Ghana/{{ $highCourt->gh_law_judgment_group_name }}/{{ $highCourt->id}}">{{ $highCourt->case_title }}</a></td>
