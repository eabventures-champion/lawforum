...
<head>
    ...
    @php
        ...
        $actTitle = $allPost1992Article['post_act'] ?? $allPost1992Article['title'] ?? 'Legal Document';
        $sectionTitle = $allPost1992Article['section'] ?? '';
        $actYear = '';
...
<body class="standalone-view">
    ...
    <div class="content-header-wrap" style="animation: fadeInUp 0.5s ease both;">
        ...
        <nav class="content-breadcrumb">
            ...
            @if(!empty($searchText))
                ...
                <span class="breadcrumb-sep"><i class="fa-solid fa-chevron-right"></i></span>
            @endif
            <a href="javascript:void(0)">Acts of Parliament</a>
            <span class="breadcrumb-sep"><i class="fa-solid fa-chevron-right"></i></span>
        ...
        <div class="content-meta-header">
            <div class="content-meta-badges">
                <span class="content-badge content-badge-category">
                    <i class="fa-solid fa-landmark"></i> Acts of Parliament
                </span>
                @if($actYear)
            ...
            <div class="content-actions-bar">
                ...
                <button type="button"
                        ...
                        data-act-id="{{ $postActId }}"
                        data-act-group="{{ $postGroup }}"
    ...
    <!-- ====== ARTICLE CONTENT ====== -->
    <div class="premium-article-container" data-sid="{{ $allPost1992Article['id'] }}" style="animation: fadeInUp 0.5s ease 0.1s both;">
