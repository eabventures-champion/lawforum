...
<head>
    ...
    @php
        ...
        $actTitle = $allPost1992Article['post_act'] ?? $allPost1992Article['regulation_title'] ?? $allPost1992Article['constitutional_act'] ?? $allPost1992Article['executive_act'] ?? $allPost1992Article['act_title'] ?? $allPost1992Article['title'] ?? 'Legal Document';
        $sectionTitle = $allPost1992Article['section'] ?? 'Section Locked';
    @endphp
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .role-card.card-disabled {
            opacity: 0.5;
            cursor: not-allowed !important;
            pointer-events: none !important;
            filter: grayscale(0.25);
        }
        .role-card.card-disabled:hover {
        ...
        .coming-soon-badge-sm .pulse-dot {
            width: 5px;
            height: 5px;
            background: #f59e0b;
            border-radius: 50%;
    ...
    <main class="gate-main">
        <div class="gate-card">
            ...
            <div class="roles-grid">
                ...
                @else
                <div class="role-card role-student card-disabled" title="Student registration is coming soon">
                    <div class="role-icon">
                        <i class="fa-solid fa-graduation-cap"></i>
                    </div>
                    <div class="role-info">
                    ...
                    <div class="role-btn-text">
                        <span class="coming-soon-badge-sm"><span class="pulse-dot"></span>Coming Soon</span>
                    </div>
                </div>
                @endif
                ...
                @else
                <div class="role-card role-lawyer card-disabled" title="Lawyer registration is coming soon">
                    <div class="role-icon">
                        <i class="fa-solid fa-scale-balanced"></i>
                    </div>
                    <div class="role-info">
                ...
                @else
                <div class="role-card role-researcher card-disabled" title="Researcher registration is coming soon">
                    <div class="role-icon">
                        <i class="fa-solid fa-microscope"></i>
                    </div>
                    <div class="role-info">
