<div class="locked-section-container" style="padding: 40px 20px; text-align: center; background: rgba(12, 18, 32, 0.6); border: 1px dashed rgba(245, 158, 11, 0.3); border-radius: 16px; margin: 20px 0;">
    ...
    <h4 style="color: #fff; font-weight: 700; margin-bottom: 8px;">
        {{ !empty($allPost1992Article['section']) ? $allPost1992Article['section'] . ' is Locked for Guest Users' : 'Section Locked for Guest Users' }}
    </h4>
    <p style="color: #94a3b8; font-size: 14px; max-width: 480px; margin: 0 auto 24px; line-height: 1.6;">
        You are currently browsing as a guest. Guest access is limited to the first 3 sections of New Laws. Please sign up as a Student, Lawyer, or Researcher to view <span style="color: #f59e0b; font-weight: 600;">{{ $allPost1992Article['section'] ?? 'this section' }}</span> and access full legal databases.
    </p>
