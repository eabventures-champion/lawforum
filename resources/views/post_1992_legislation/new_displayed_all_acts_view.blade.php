...
<html lang="en">
   ...
   <body class="bg-light">
      ...
      {{-- @include('ads.manual_ads_homepage') --}}
                        ...
                        <div class="list-group">
                           <table class="table table-striped table-condensed" id="datatable">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td>
                                       <a href="/post-1992-legislation/table-of-content/{{$allPost1992Act->post_group}}/{{ $allPost1992Act->title }}/{{ $allPost1992Act->id}}">
                                          <li style="list-style: none;">{{ $allPost1992Act->title }}</li>
                                       </a>
                                    </td>
                                 ...
                                 <tr>
                                    <td>
                                       <a href="/post-1992-legislation/constitutional-acts-table-of-content/{{$allConstitutionalAct->constitutional_group}}/{{ $allConstitutionalAct->title }}/{{ $allConstitutionalAct->id}}">
                                          <li style="list-style: none;">{{ $allConstitutionalAct->title }}</li>
                                       </a>
                                    </td>
                                 ...
                                 <tr>
                                    <td>
                                       <a href="/post-1992-legislation/table-of-content/{{$allExecutiveAct->executive_group}}/{{ $allExecutiveAct->title }}/{{ $allExecutiveAct->id}}">
                                          <li style="list-style: none;">{{ $allExecutiveAct->title }}</li>
                                       </a>
                                    </td>
                                 ...
                                 <tr>
                                    <td>
                                       <a href="/post_1992_legislation/regulation_acts_table_of_content/{{$allPostRegulation->act_category}}/{{ $allPostRegulation->title }}/{{ $allPostRegulation->id}}">
                                          <li style="list-style: none;">{{ $allPostRegulation->title }}</li>
                                       </a>
                                    </td>
                                 ...
                                 <tr>
                                    <td>
                                       <a href="/post_1992_legislation/amended_acts_table_of_content/{{$allPostsAmend->post_category}}/{{ $allPostsAmend->title }}/{{ $allPostsAmend->id}}">
                                          <li style="list-style: none;">{{ $allPostsAmend->title }}</li>
                                       </a>
                                    </td>
                                 ...
                                 <tr>
                                    <td>
                                       <a href="/post_1992_legislation/amended_regulation_acts_table_of_content/{{$allPostsAmendsOnRegulation->act_category}}/{{ $allPostsAmendsOnRegulation->title }}/{{ $allPostsAmendsOnRegulation->id}}">
                                          <li style="list-style: none;">{{ $allPostsAmendsOnRegulation->title }}</li>
                                       </a>
                                    </td>
