  ...
  <head>
    ...
    <style>
        ...
        .dataTables_wrapper .dataTables_paginate .paginate_button {
            ...
            border: 1px solid var(--border-color) !important; background: rgba(17,24,39,0.5) !important;
            padding: 6px 12px !important; margin: 0 3px; font-weight: 600 !important;
        ...
        .dataTables_wrapper .dataTables_paginate .paginate_button.current:hover {
            ...
            border-color: transparent !important; box-shadow: 0 4px 10px var(--accent-glow) !important;
        }
        .dataTables_wrapper .dataTables_paginate .paginate_button.disabled,
        .dataTables_wrapper .dataTables_paginate .paginate_button.disabled:hover {
            opacity: 0.4 !important; background: rgba(17,24,39,0.3) !important;
            color: var(--text-muted) !important; cursor: not-allowed !important;
        }
