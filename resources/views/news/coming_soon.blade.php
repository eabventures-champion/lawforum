...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('news/css/bootstrap.min.css') }}">                                  <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="{{ asset('news/fontawesome/css/fontawesome-all.min.css') }}">                <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" type="text/css" href="{{ asset('news/') }}slick/slick.css"/>                       <!-- http://kenwheeler.github.io/slick/ -->
    <link rel="stylesheet" type="text/css" href="{{ asset('news/slick/slick-theme.css') }}"/>
    <link rel="stylesheet" href="{{ asset('news/css/tooplate-style.css') }}">                               <!-- Templatemo style -->
...
<body>
                                ...
                                <div class="grid__item">
                                    <div class="product">
                                        <div class="tm-nav-link">
                                            ...
                                            <span class="tm-nav-text">Lawyers</span>
                                            <div class="product__bg"></div>             
                                        </div>                                                                 
                                        <div class="product__description">
                                            {{-- <div class="p-sm-4 p-2">
    ...
    <!-- load JS -->
    <script src="{{ asset('news/js/jquery-3.2.1.slim.min.js') }}"></script>         <!-- https://jquery.com/ -->    
    <script src="{{ asset('news/slick/slick.min.js') }}"></script>                  <!-- http://kenwheeler.github.io/slick/ -->  
    <script src="{{ asset('news/js/anime.min.js') }}"></script>                     <!-- http://animejs.com/ -->
