<div class="card premium-placeholder-ad" style="background: linear-gradient(135deg, #0f172a, #1e293b); border: 1px dashed rgba(245, 158, 11, 0.25); border-radius: 12px; overflow: hidden; padding: 24px; text-align: center; box-shadow: 0 4px 20px rgba(0,0,0,0.25); transition: all 0.3s ease; margin-bottom: 0 !important;">
