...
<div class="content-card">
    ...
    <p class="card-subtitle">Update your personal contact details, region location, and login email address.</p>
    ...
    <form method="POST" action="{{ route('users.update', $user) }}">
        ...
        <div class="form-grid-2">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input id="lname" type="text" class="form-control" name="lname" value="{{ old('lname', $user->lname) }}" required>
