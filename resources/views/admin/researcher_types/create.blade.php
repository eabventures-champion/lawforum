...
@section('title', 'Add Researcher Type')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title">Add Researcher Type</h1>
        <p class="page-subtitle">Create a new option for the "I am a..." registration dropdown.</p>
    </div>
...
<div class="card-table" style="padding: 32px;">
    <form action="{{ route('admin.researcher-types.store') }}" method="POST">
        @csrf
        ...
        <div style="margin-bottom: 24px;">
            ...
            <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0" style="width: 100%; max-width: 150px; padding: 10px 14px; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: 8px; color: var(--text-primary); font-size: 14px; outline: none; transition: border-color 0.2s;" onfocus="this.style.borderColor='var(--primary-color)'" onblur="this.style.borderColor='var(--border-color)'">
        ...
        <div style="display: flex; gap: 12px;">
            <button type="submit" class="btn btn-primary btn-action">
                <i class="fa-solid fa-check"></i> Create Type
            </button>
