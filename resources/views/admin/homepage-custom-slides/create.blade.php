...
@section('title', 'Create Custom Slide Panel')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title">Create Custom Slide Panel</h1>
        <p class="page-subtitle">Configure the title, content layout, navigation icon, and button actions for the new slide.</p>
    </div>
...
<div class="card-table" style="max-width: 900px; padding: 32px; border-radius: 20px;">
    <form action="{{ route('admin.homepage-custom-slides.store') }}" method="POST">
        @csrf

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            <div class="form-group">
                <label for="title" class="form-label">Panel Title (Required)</label>
                <input type="text" id="title" name="title" class="form-control" placeholder="e.g. Premium Library" value="{{ old('title') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="subtitle" name="subtitle" class="form-control" placeholder="e.g. Exclusive Features" value="{{ old('subtitle') }}">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-top: 16px;">
            <div class="form-group">
                ...
                <input type="text" id="icon" name="icon" class="form-control" placeholder="e.g. fa-book-open, fa-balance-scale, fa-star" value="{{ old('icon', 'fa-circle-dot') }}" required>
        ...
        <div class="form-group" style="margin-top: 16px;">
            ...
            <textarea id="content" name="content" class="form-control" style="min-height: 120px;" placeholder="Write a short pitch or description about this section...">{{ old('content') }}</textarea>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-top: 16px;">
            <div class="form-group">
                ...
                <input type="text" id="btn_text" name="btn_text" class="form-control" placeholder="e.g. Get Instant Access" value="{{ old('btn_text') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="btn_link" name="btn_link" class="form-control" placeholder="e.g. /subscription, https://..." value="{{ old('btn_link') }}">
        ...
        <div class="setting-switch-wrapper" style="margin-top: 16px;">
            <label class="switch">
                <input type="checkbox" name="is_coming_soon" value="1" {{ old('is_coming_soon') == '1' ? 'checked' : '' }}>
                <span class="slider"></span>
            </label>
            <div>
        ...
        <div style="margin-top: 32px; border-top: 1px solid var(--border-color); padding-top: 24px;">
            <button type="submit" class="btn btn-primary" style="width: 100%; justify-content: center; padding: 14px; font-size: 15px;">
                <i class="fa-solid fa-floppy-disk"></i> Create Custom Panel
            </button>
        </div>
    </form>
</div>
