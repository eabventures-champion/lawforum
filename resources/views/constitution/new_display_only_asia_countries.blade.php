...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>Asian Constitutions - Legals Forum</title>
  ...
  <body>
    ...
    <div class="container-fluid px-md-5 mt-4">
        ...
        <!-- Header Text Block -->
        <div class="mb-4">
            <h1 class="page-title" style="font-size: 2.2rem; font-weight: 800; font-family: 'Outfit', sans-serif; letter-spacing: -0.5px; background: linear-gradient(135deg, #fff 0%, #94a3b8 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Asian Constitutions</h1>
            <p class="page-subtitle" style="font-size: 15px; color: var(--text-secondary); max-width: 700px; line-height: 1.6;">Browse, filter, and search constitution indexes and documents across Asia.</p>
        </div>
                        ...
                        @if($m->slug === 'constitution' || strtolower($m->title) === 'constitution')
                            @foreach($m->children as $child)
                                ...
                                @php
                                    ...
                                    if ('Asia' == 'all') {
                                        $isActive = false;
                                    } elseif ('Asia' == 'Africa' && stripos($child->title, 'Africa') !== false) {
                                        $isActive = true;
                                    } elseif ('Asia' == 'Asia' && stripos($child->title, 'Asia') !== false) {
                                        $isActive = true;
                                    } elseif ('Asia' == 'Europe' && stripos($child->title, 'Europe') !== false) {
                                        $isActive = true;
                                    } elseif ('Asia' == 'North-America' && stripos($child->title, 'North America') !== false) {
                                        $isActive = true;
                                    } elseif ('Asia' == 'South-America' && stripos($child->title, 'South America') !== false) {
                                        $isActive = true;
                                    }
                                @endphp
                            ...
                            <tbody>
                              @foreach($asiaConstitutions as $asiaConstitution)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/constitution/1/{{ $asiaConstitution->continent }}/{{ $asiaConstitution->country }}/{{ $asiaConstitution->id}}">{{ $asiaConstitution->title }}</a>
                                    </td> 
