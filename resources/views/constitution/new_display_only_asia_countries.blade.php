  ...
  <body>
    ...
    <div class="continent-nav-wrap">
        <div class="nav-scroller">
            <nav class="nav nav-underline">
                ...
                <a class="nav-link active" href="/constitution/all-countries/2/Asia">Asia</a>
    ...
    <div class="main-container">
        <div class="dashboard-hero">
            <h1>Asian Constitutions</h1>
            <p>Browse, filter, and search constitution indexes and documents across Asia.</p>
        </div>
        ...
        <div class="row align-items-start">
                        ...
                        <tbody>
                            @foreach($asiaConstitutions as $asiaConstitution)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/constitution/1/{{ $asiaConstitution->continent }}/{{ $asiaConstitution->country }}/{{ $asiaConstitution->id}}">
                                            {{ $asiaConstitution->title }}
                                        </a>
                                    </td> 
            ...
            <div class="col-lg-3">
                <div class="premium-card">
                    ...
                    <select class="form-control asia_constitution_filter_year input-premium mb-2">
                        <option value="">Select Year</option>
                        @foreach($asiaConstitutions->pluck('year')->unique()->sortDesc() as $year)
                    ...
                    <select class="form-control asia_constitution_filter_country input-premium mb-3">
                        <option value="">Select Country</option>
                        @foreach($asiaConstitutions->pluck('country')->unique()->sort() as $country)
                            <option value="{{ $country }}">{{ $country }}</option>
                        @endforeach
                    </select>

                    <button type="button" class="btn btn-accent w-100 mb-4" id="asia_constitution_filter">
