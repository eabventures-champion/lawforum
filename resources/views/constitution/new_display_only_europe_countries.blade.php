...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>European Constitutions - Legals Forum</title>
                        ...
                        @if($m->slug === 'constitution' || strtolower($m->title) === 'constitution')
                            @foreach($m->children as $child)
                                ...
                                @php
                                    ...
                                    if ('Europe' == 'all') {
                                        $isActive = false;
                                    } elseif ('Europe' == 'Africa' && stripos($child->title, 'Africa') !== false) {
                                        $isActive = true;
                                    } elseif ('Europe' == 'Asia' && stripos($child->title, 'Asia') !== false) {
                                        $isActive = true;
                                    } elseif ('Europe' == 'Europe' && stripos($child->title, 'Europe') !== false) {
                                        $isActive = true;
                                    } elseif ('Europe' == 'North-America' && stripos($child->title, 'North America') !== false) {
                                        $isActive = true;
                                    } elseif ('Europe' == 'South-America' && stripos($child->title, 'South America') !== false) {
                                        $isActive = true;
                                    }
                                @endphp
                            ...
                            <tbody>
                              @foreach($europeConstitutions as $europeConstitution)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/constitution/1/{{ $europeConstitution->continent }}/{{ $europeConstitution->country }}/{{ $europeConstitution->id}}">{{ $europeConstitution->title }}</a>
                                    </td> 
