...
<head>
    ...
    @php
        ...
        $actTitle = 'The Constitution of the Republic of Ghana 1992';
        $sectionTitle = $constitutionContent['section'] ?? '';
        $actYear = '1992';
    @endphp
...
<body class="standalone-view">
    ...
    <div class="content-header-wrap" style="animation: fadeInUp 0.5s ease both;">
        ...
        <nav class="content-breadcrumb">
            ...
            @if(!empty($searchText))
                ...
                <span class="breadcrumb-sep"><i class="fa-solid fa-chevron-right"></i></span>
            @endif
            <a href="javascript:void(0)">Constitution</a>
            <span class="breadcrumb-sep"><i class="fa-solid fa-chevron-right"></i></span>
        ...
        <div class="content-meta-header">
            <div class="content-meta-badges">
                <span class="content-badge content-badge-category">
                    <i class="fa-solid fa-landmark"></i> Constitution (Ghana)
                </span>
                <span class="content-badge content-badge-year">
                    <i class="fa-regular fa-calendar"></i> 1992
                </span>
            </div>
            ...
            <div class="content-actions-bar">
                @php
                    ...
                    if (auth()->check()) {
                        $isBookmarked = \App\UserBookmark::where('user_id', auth()->id())
                            ->where(function($q) use ($constitutionContent) {
                                $q->where('section_id', $constitutionContent['id'])
                                  ->orWhere('user_section', auth()->id() . '_constitution_1_' . $constitutionContent['id']);
                            })->exists();
                    }
                @endphp
                ...
                <button type="button"
                        ...
                        data-act-section="{{ $constitutionContent['section'] }}"
                        data-section-id="{{ $constitutionContent['id'] }}"
                        data-act-id="1"
                        data-act-group="Constitution"
                        data-doc-type="constitution"
                        data-page-url="/constitution/Republic/Ghana/1#article-{{ $constitutionContent['id'] }}"
    ...
    <!-- ====== ARTICLE CONTENT ====== -->
    <div class="premium-article-container" data-sid="{{ $constitutionContent['id'] }}" style="animation: fadeInUp 0.5s ease 0.1s both;">
