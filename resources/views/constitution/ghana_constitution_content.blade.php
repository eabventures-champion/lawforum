        ...
        <div class="nav-links">
            ...
            <div class="actions-container">
                ...
                <div class="menu_options" style="display: none;">
                    @if (Route::has('login'))
                        @auth
                            <a href="/constitution/Republic/pdf_article_content/{{$constitutionContent['chapter']}}/{{ $constitutionContent['id'] }}">
                                <i class="fa-solid fa-file-pdf text-red"></i> PDF Download
                            </a>
                            <a href="/constitution/Republic/print_article_content/{{ $constitutionContent['id'] }}" target="_blank">
