...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>North American Constitutions - Legals Forum</title>
  ...
  <body>
    ...
    <div class="container-fluid px-md-5 mt-4">
        ...
        <!-- Header Text Block -->
        <div class="mb-4">
            <h1 class="page-title" style="font-size: 2.2rem; font-weight: 800; font-family: 'Outfit', sans-serif; letter-spacing: -0.5px; background: linear-gradient(135deg, #fff 0%, #94a3b8 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">North American Constitutions</h1>
            <p class="page-subtitle" style="font-size: 15px; color: var(--text-secondary); max-width: 700px; line-height: 1.6;">Browse, filter, and search constitution indexes and documents across North America.</p>
        </div>
        ...
        <div class="row">
                    ...
                    @foreach($headerMenus as $m)
                        @if($m->slug === 'constitution' || strtolower($m->title) === 'constitution')
                            @foreach($m->children as $child)
                                ...
                                @php
                                    $isActive = false;
                                    if ('North-America' == 'all') {
                                        $isActive = false;
                                    } elseif ('North-America' == 'Africa' && stripos($child->title, 'Africa') !== false) {
                                        $isActive = true;
                                    } elseif ('North-America' == 'Asia' && stripos($child->title, 'Asia') !== false) {
                                        $isActive = true;
                                    } elseif ('North-America' == 'Europe' && stripos($child->title, 'Europe') !== false) {
                                        $isActive = true;
                                    } elseif ('North-America' == 'North-America' && stripos($child->title, 'North America') !== false) {
                                        $isActive = true;
                                    } elseif ('North-America' == 'South-America' && stripos($child->title, 'South America') !== false) {
                                        $isActive = true;
                                    }
                                @endphp
                            ...
                            <tbody>
                              @foreach($north_americaConstitutions as $north_americaConstitution)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/constitution/1/{{ $north_americaConstitution->continent }}/{{ $north_americaConstitution->country }}/{{ $north_americaConstitution->id}}">{{ $north_americaConstitution->title }}</a>
                                    </td> 
            ...
            <div class="col-md-3">
                <!-- Advertisement Cards -->
                <div class="premium-sidebar-card p-2" style="background: transparent !important; border: none !important; box-shadow: none !important; margin-bottom: 8px !important;">
                    @include('ads.small_ads_image_main_page')
                </div>

                <div class="premium-sidebar-card p-2" style="background: transparent !important; border: none !important; box-shadow: none !important; margin-top: 0 !important;">
