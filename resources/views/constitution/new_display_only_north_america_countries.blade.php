...
<html lang="en">
  <head>
    ...
    <title>North America Constitutions - LawsGhana</title>
  ...
  <body>
    ...
    <div class="continent-nav-wrap">
        <div class="nav-scroller">
            <nav class="nav nav-underline">
                ...
                <a class="nav-link active" href="/constitution/all-countries/4/North-America">North America</a>
    ...
    <div class="main-container">
        <div class="dashboard-hero">
            <h1>North American Constitutions</h1>
            <p>Browse, filter, and search constitution indexes and documents across North America.</p>
        </div>
        ...
        <div class="row align-items-start">
                        ...
                        <tbody>
                            @foreach($north_americaConstitutions as $north_americaConstitution)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/constitution/1/{{ $north_americaConstitution->continent }}/{{ $north_americaConstitution->country }}/{{ $north_americaConstitution->id}}">
                                            {{ $north_americaConstitution->title }}
                                        </a>
                                    </td> 
            ...
            <div class="col-lg-3">
                <div class="premium-card">
                    ...
                    <select class="form-control north_america_constitution_filter_year input-premium mb-2">
                        <option value="">Select Year</option>
                        @foreach($north_americaConstitutions->pluck('year')->unique()->sortDesc() as $year)
                    ...
                    <select class="form-control north_america_constitution_filter_country input-premium mb-3">
                        <option value="">Select Country</option>
                        @foreach($north_americaConstitutions->pluck('country')->unique()->sort() as $country)
                            <option value="{{ $country }}">{{ $country }}</option>
                        @endforeach
                    </select>

                    <button type="button" class="btn btn-accent w-100 mb-4" id="north_america_constitution_filter">
