        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 mt-md-4 mt-lg-0">
                <div class="premium-sidebar-card">
                    ...
                    <form action="{{ url('first_republic_index_search') }}" method="GET" style="margin-top: 15px;">
                        {{ csrf_field() }}
                        <input class="premium-input" name="search_text" type="text" placeholder="First Republic search" aria-label="Search" style="width: 100%;">
                    </form>
                </div>
