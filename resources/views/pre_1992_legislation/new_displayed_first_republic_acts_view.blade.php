...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>First Republic - Legals Forum</title>
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">First Republic Legislation</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
                              @foreach($firstRepublicActs as $firstRepublicAct)
                                <tr>
                                    <td>
                                        <a href="/pre_1992_legislation/{{ $firstRepublicAct->pre_1992_group }}/{{ $firstRepublicAct->title }}/{{ $firstRepublicAct->id }}">{{ $firstRepublicAct->title }}</a>
                                    </td> 
