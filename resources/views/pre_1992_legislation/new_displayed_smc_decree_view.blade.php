...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>SMC Decree - Legals Forum</title>
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <div class="sidebar-decree-group expanded" id="decreeGroup">
                            ...
                            <div class="decree-sub-links">
                                ...
                                <a class="vertical-nav-link decree-sub-link active" data-group="7" data-label="SMC Decree" href="javascript:void(0)"><i class="fa-solid fa-file-contract mr-3" style="width: 16px; text-align: center;"></i> SMCD</a>
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">SMC Decree</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
