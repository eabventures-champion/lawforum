...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>NRC Decree - Legals Forum</title>
        ...
        <div class="row">
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">NRC Decree</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
                              @foreach($nrcDecrees as $nrcDecree)
                                <tr>
                                    <td>
                                        <a href="/pre_1992_legislation/{{ $nrcDecree->pre_1992_group }}/{{ $nrcDecree->title }}/{{ $nrcDecree->id }}">{{ $nrcDecree->title }}</a>
                                    </td> 
            ...
            <div class="col-lg-3 col-md-12 mt-md-4 mt-lg-0">
                <div class="premium-sidebar-card">
                    ...
                    <form action="{{ url('nrc_decree_index_search') }}" method="GET" style="margin-top: 15px;">
                        {{ csrf_field() }}
