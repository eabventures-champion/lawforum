...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>PNDC Laws - Legals Forum</title>
            ...
            <div class="col-lg-3 col-md-4 mobile-sidebar-drawer" id="leftSidebarCol">
                ...
                <div class="premium-sidebar-card p-0" style="overflow: hidden; position: sticky; top: 90px;">
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <a class="vertical-nav-link active" data-group="4" data-label="PNDC Laws" href="javascript:void(0)"><i class="fa-solid fa-book mr-3" style="width: 16px; text-align: center;"></i> PNDC Law</a>
                    </div>
                </div>
            </div>
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">PNDC Laws</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
                              @foreach($pndcLaws as $pndcLaw)
                                <tr>
                                    <td>
                                        <a href="/existing-laws/{{ $pndcLaw->pre_1992_group }}/{{ $pndcLaw->title }}/{{ $pndcLaw->id }}">{{ $pndcLaw->title }}</a>
                                    </td> 
                                    <td>{{ $pndcLaw->year }}</td>  
                                </tr>
                              @endforeach
