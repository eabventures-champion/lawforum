        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="premium-sidebar-card p-0" style="overflow: hidden; position: sticky; top: 90px;">
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <a class="vertical-nav-link active" data-group="7" data-label="SMC Decree" href="javascript:void(0)"><i class="fa-solid fa-file-contract mr-3" style="width: 16px; text-align: center;"></i> SMCD</a>
            ...
            <div class="col-lg-3 col-md-12 mt-md-4 mt-lg-0">
                <div class="premium-sidebar-card">
                    ...
                    <form action="{{ url('smc_decree_index_search') }}" method="GET" style="margin-top: 15px;">
                        {{ csrf_field() }}
