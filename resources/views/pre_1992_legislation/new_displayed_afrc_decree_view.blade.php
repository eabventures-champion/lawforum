...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>AFRC Decree - Legals Forum</title>
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <div class="sidebar-decree-group expanded" id="decreeGroup">
                            ...
                            <div class="decree-sub-links">
                                ...
                                <a class="vertical-nav-link decree-sub-link active" data-group="8" data-label="AFRC Decree" href="javascript:void(0)"><i class="fa-solid fa-signature mr-3" style="width: 16px; text-align: center;"></i> AFRCD</a>
                            </div>
                        </div>
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">AFRC Decree</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
                              @foreach($afrcDecrees as $afrcDecree)
                                <tr>
                                    <td>
                                        <a href="/pre_1992_legislation/{{ $afrcDecree->pre_1992_group }}/{{ $afrcDecree->title }}/{{ $afrcDecree->id }}">{{ $afrcDecree->title }}</a>
                                    </td> 
