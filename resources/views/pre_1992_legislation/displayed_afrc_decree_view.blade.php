            ...
            <div class="col-lg-3 col-md-4">
                <div class="premium-sidebar-card p-0" style="overflow: hidden; position: sticky; top: 90px;">
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <a class="vertical-nav-link active" data-group="8" data-label="AFRC Decree" href="javascript:void(0)"><i class="fa-solid fa-signature mr-3" style="width: 16px; text-align: center;"></i> AFRCD</a>
                ...
                <div class="premium-sidebar-card">
                    ...
                    <select class="premium-select all_judgment_filter_category">
                        ...
                        @foreach($afrcCategories as $afrcCategory)
                            <option value="{{ $afrcCategory->name }}">{{ $afrcCategory->name }}</option>
                        @endforeach 
                    </select>
                    <form action="{{ url('afrc_decree_index_search') }}" method="GET" style="margin-top: 15px;">
                        {{ csrf_field() }}
