        ...
        <div class="nav-links">
            ...
            <div class="actions-container">
                ...
                <div class="menu_options" style="display: none;">
                    @if (Route::has('login'))
                        @auth
                            <a class="download_link" href="javascript:;" rel="/pre_1992_legislation/pdf/content/{{$allPre1992Article['pre_1992_act']}}/{{ $allPre1992Article['id'] }}">
                                <i class="fa-solid fa-file-pdf text-red"></i> PDF Download
                            </a>
                            <a class="d-none section_id" href="javascript:;" rel="/section_downloads/{{$allPre1992Article['pre_1992_act']}}/{{$allPre1992Article['section']}}/{{$allPre1992Article['id']}}/{{ Auth::user()->name }}/{{ Auth::user()->id }}/{{ Auth::user()->id }}{{$allPre1992Article['section']}}/{{$allPre1992Article['act_group']}}/{{$allPre1992Article['act_id']}}">Testing</a>
                            <a href="/pre_1992_legislation/print_section_content/{{ $allPre1992Article['id'] }}" target="_blank">
