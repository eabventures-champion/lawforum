...
<html lang="en" style="background-color:#060a13;">
  ...
  <body class="bg-light" style="background-color:#060a13;">
    <!-- ====== PREMIUM NAVIGATION ====== -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-gavel mr-2"></i> Select Existing Laws Laws</h5>
    ...
    <script>
        ...
        @php
            $mappedArticles = $allPre1992Articles->map(function($article) {
                return [
                    'id' => $article->id,
        ...
        const preambleText = @json(strip_tags($allPre1992Act['preamble'] ?? ''));
        const pre1992ActId = @json($allPre1992Act['id']);
        const pre1992Group = @json($allPre1992Act['pre_1992_group']);
        const pre1992Title = @json($allPre1992Act['title']);
        ...
        $(document).on('click', '.previous_content_pre_act, .next_content_pre_act', function(e) {
            if ($('#v-pills-split-tab').hasClass('active')) {
                e.preventDefault();
                e.stopImmediatePropagation();
                
                const isNext = $(this).hasClass('next_content_pre_act');
    ...
    function getCurrentArticleSection() {
        var activeLink = document.querySelector('.panel-group .pre_content_link.pre_content_active, a.pre_content_link.pre_content_active, a.pre_content_link.active-article-highlight');
