        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="premium-sidebar-card p-0" style="overflow: hidden; position: sticky; top: 90px;">
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <a class="vertical-nav-link active" data-group="5" data-label="NLC Decree" href="javascript:void(0)"><i class="fa-solid fa-building-columns mr-3" style="width: 16px; text-align: center;"></i> NLCD</a>
            ...
            <div class="col-lg-3 col-md-12 mt-md-4 mt-lg-0">
                <div class="premium-sidebar-card">
                    ...
                    <form action="{{ url('nlc_decree_index_search') }}" method="GET" style="margin-top: 15px;">
                        {{ csrf_field() }}
