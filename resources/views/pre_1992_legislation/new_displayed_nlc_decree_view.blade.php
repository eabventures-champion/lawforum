...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>NLC Decree - Legals Forum</title>
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <div class="sidebar-decree-group expanded" id="decreeGroup">
                            ...
                            <div class="decree-sub-links">
                                <a class="vertical-nav-link decree-sub-link active" data-group="5" data-label="NLC Decree" href="javascript:void(0)"><i class="fa-solid fa-building-columns mr-3" style="width: 16px; text-align: center;"></i> NLCD</a>
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">NLC Decree</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
                              @foreach($nlcDecrees as $nlcDecree)
                                <tr>
                                    <td>
                                        <a href="/pre_1992_legislation/{{ $nlcDecree->pre_1992_group }}/{{ $nlcDecree->title }}/{{ $nlcDecree->id }}">{{ $nlcDecree->title }}</a>
                                    </td> 
