...
<html lang="en" style="background-color:#070a13;">
  <head>
    ...
    <title>Second Republic - Legals Forum</title>
            ...
            <div class="col-lg-3 col-md-4 mobile-sidebar-drawer" id="leftSidebarCol">
                ...
                <div class="premium-sidebar-card p-0" style="overflow: hidden; position: sticky; top: 90px;">
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <a class="vertical-nav-link active" data-group="2" data-label="Second Republic Legislation" href="javascript:void(0)"><i class="fa-solid fa-scale-balanced mr-3" style="width: 16px; text-align: center;"></i> 2nd Republic</a>
                        ...
                        <div class="sidebar-decree-group" id="decreeGroup">
                            ...
                            <div class="decree-sub-links">
                                ...
                                <a class="vertical-nav-link decree-sub-link " data-group="6" data-label="NRC Decree" href="javascript:void(0)"><i class="fa-solid fa-scroll mr-3" style="width: 16px; text-align: center;"></i> NRCD</a>
                ...
                <div class="premium-card" style="position: relative;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="datatable" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th id="thColumnName">Second Republic Legislation</th>
                                    <th>Year</th>
                                </tr>
                            </thead>
                            <tbody>
                              @foreach($secondRepublicActs as $secondRepublicAct)
                                <tr>
                                    <td>
                                        <a href="/pre_1992_legislation/{{ $secondRepublicAct->pre_1992_group }}/{{ $secondRepublicAct->title }}/{{ $secondRepublicAct->id }}">{{ $secondRepublicAct->title }}</a>
                                    </td> 
