            ...
            <div class="col-lg-3 col-md-4">
                <div class="premium-sidebar-card p-0" style="overflow: hidden; position: sticky; top: 90px;">
                    ...
                    <div class="vertical-nav-group" id="sidebarNav">
                        ...
                        <a class="vertical-nav-link active" data-group="4" data-label="PNDC Laws" href="javascript:void(0)"><i class="fa-solid fa-book mr-3" style="width: 16px; text-align: center;"></i> PNDC</a>
                    </div>
                </div>
            </div>
